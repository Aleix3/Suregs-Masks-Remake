...
public class Player : MonoBehaviour
{
    ...
    public Vector2 offsetUp = new Vector2(0, 1.5f);
    public Vector2 offsetDown = new Vector2(0, -1.5f);
    public Vector2 offsetLeft = new Vector2(-1.5f, 0);
    public Vector2 offsetRight = new Vector2(1.5f, 0);
